# Dynamo Deep-Dive[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#dynamo-deep-dive "Link to this heading")

Created On: Apr 02, 2024 | Last Updated On: Jan 08, 2026
...
## A Gentle Introduction to Dynamo[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#a-gentle-introduction-to-dynamo "Link to this heading")
...
of PyTorch operations. [[1]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id8) Dynamo records all the PyTorch operations
...
## PEP 523: Adding a frame evaluation API to CPython[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#pep-523-adding-a-frame-evaluation-api-to-cpython "Link to this heading")
...
[here](https://github.com/pytorch/pytorch/blob/e891a3bba9f05697d72776f6e89347231a141f03/torch/csrc/dynamo/eval_frame.c#L50-L59). [[2]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id9)

In summary, CPython provides the user’s interpreter with all the
information necessary to execute the function. [[3]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id10)
...
## Implementing CPython in Python[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#implementing-cpython-in-python "Link to this heading")
...
landed at
[\_convert\_frame\_assert](https://github.com/pytorch/pytorch/blob/b6df8414601e1e086e830ca9e919e7fdc8874e71/torch/_dynamo/convert_frame.py#L272-L274).
...
in
[symbolic\_convert.py](https://github.com/pytorch/pytorch/blob/69f112d5867f785a3a090a0c6d6644ae047033ac/torch/_dynamo/symbolic_convert.py).
...
## Generating the Output Graph[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#generating-the-output-graph "Link to this heading")
...
the graph by calling [create\_proxy](https://github.com/pytorch/pytorch/blob/fb80f05ee2e1cba17892980701bfd5dbce58349f/torch/_dynamo/output_graph.py#L430-L431).
Then, we can add it to the graph through the function
[wrap\_fx\_proxy](https://github.com/pytorch/pytorch/blob/fb80f05ee2e1cba17892980701bfd5dbce58349f/torch/_dynamo/variables/builder.py#L1311).
...
## Making Dynamo Sound: Guards[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#making-dynamo-sound-guards "Link to this heading")
...
## Symbolic Shapes[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#symbolic-shapes "Link to this heading")
...
it in the output FX graph. [[4]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id11) We already saw this class in the introduction
...
### Static by default[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#static-by-default "Link to this heading")
...
[torch.\_dynamo.mark\_dynamic](https://github.com/pytorch/pytorch/blob/66a76516bfc341b2b55bb2056d2faa9c2de46d69/torch/_dynamo/decorators.py#L176)
...
### 0, 1 are always specialized[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#are-always-specialized "Link to this heading")
...
### Duck shaping[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#duck-shaping "Link to this heading")
...
### Guards on symbolic ints[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#guards-on-symbolic-ints "Link to this heading")
...
## Making Dynamo Complete: Graph Breaks[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#making-dynamo-complete-graph-breaks "Link to this heading")
...
understand NumPy? and Django? [[5]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id12)
...
after. [[6]](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id13) Then, at runtime, it will delegate to CPython to execute the
...
## Conclusion[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#conclusion "Link to this heading")
...
## Footnotes[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#footnotes "Link to this heading")

Below are additional details and references for concepts mentioned in this document.

---

[[1](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id1)]

In the literature, this is called a Directed Acyclical Graph (DAG).

[[2](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id2)]

All this binding code lives in `torch/csrc/dynamo/eval_frame.c`.

[[3](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id3)]
...
[[4](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id5)]

There are also `SymBool` and `SymFloat` classes. The latter one
is not used all that much at the time of this writing.

[[5](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id6)]
...
[[6](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamo_deepdive.html#id7)]
