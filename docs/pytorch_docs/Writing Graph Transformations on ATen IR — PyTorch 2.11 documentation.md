# Writing Graph Transformations on ATen IR[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#writing-graph-transformations-on-aten-ir "Link to this heading")

Created On: Jun 11, 2025 | Last Updated On: Dec 03, 2025

## Passes[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#passes "Link to this heading")
...
### Transformer[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#transformer "Link to this heading")
...
#### One-to-One Pass[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#one-to-one-pass "Link to this heading")
...
#### One-to-X Pass[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#one-to-x-pass "Link to this heading")
...
#### One-to-None Pass[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#one-to-none-pass "Link to this heading")
...
#### Utilizing Local Information[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#utilizing-local-information "Link to this heading")
...
### Subgraph Rewriter[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#subgraph-rewriter "Link to this heading")
...
## Pass Manager[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#pass-manager "Link to this heading")
...
## Partitioner[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#partitioner "Link to this heading")

There are a couple of common FX graph based partitioners we can use to
partition the graph.

### Subgraph Matcher[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#subgraph-matcher "Link to this heading")
...
### Capability Based Partitioner[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_transformations.html#capability-based-partitioner "Link to this heading")
