# Advanced Options to Control Dynamic Behavior[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#advanced-options-to-control-dynamic-behavior "Link to this heading")

Created On: Sep 22, 2025 | Last Updated On: Dec 03, 2025
...
## Profile-Guided Optimization (PGO)[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#profile-guided-optimization-pgo "Link to this heading")
...
### Identifying Dynamic Elements Marked by PGO[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#identifying-dynamic-elements-marked-by-pgo "Link to this heading")
...
1. In the `tlparse` output, identify the line number of the frame of interest. Example:
   ...
   ![../../../_images/tlparse4_pgo.png](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse4_pgo.png)
...
## Compiler Collective[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#compiler-collective "Link to this heading")
...
## Reducing Compilations: Step by Step[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#reducing-compilations-step-by-step "Link to this heading")

If you have a model that you can run on your master job and have a `tlparse`,
here’s whatyou should do next:

### Step 1: Mark Dynamic Elements[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#step-1-mark-dynamic-elements "Link to this heading")
...
2. Mark them as dynamic using one of the [User Annotations](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamic_shapes.html#user-annotations).

#### How to Identify Elements to Mark as Dynamic[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#how-to-identify-elements-to-mark-as-dynamic "Link to this heading")

Follow these guidelines:

1. **PGO artifact:** Follow the steps in [Identifying Dynamic Elements Marked by PGO](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#identifying-dynamic-elements-marked-by-pgo).
...
![../../../_images/tlparse5_dynamic_shapes.png](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse5_dynamic_shapes.png)
...
### Step 2: Debugging: Identifying Missed Opportunities[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#step-2-debugging-identifying-missed-opportunities "Link to this heading")
...
#### Finding Similar Graphs[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#finding-similar-graphs "Link to this heading")
...
#### Quick Checks: Fail Fast[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#quick-checks-fail-fast "Link to this heading")
...
![../../../_images/tlparse6_size_related_recompilations.png](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse6_size_related_recompilations.png)

In the one below it is not, which indicates that dynamic shapes won’t resolve it:

[![../../../_images/tlparse7_not_size_related_recompilations.png](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse7_not_size_related_recompilations.png)](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse7_not_size_related_recompilations.png)
...
## **Identifying and Fixing Recompilation Causes**[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_advanced_control_options.html#identifying-and-fixing-recompilation-causes "Link to this heading")
...
3. **Is a Dynamic Element Getting Specialized?** Determine why it is specialized.
   ...
   - **Using tlparse:** Check the `compilation_metrics` for a specialization section, which will indicate what got specialized and the user and framework stack when it happened. Example:![../../../_images/tlparse8_compilation_metrics.png](./Advanced Options to Control Dynamic Behavior — PyTorch 2.11 documentation_files/tlparse8_compilation_metrics.png)
