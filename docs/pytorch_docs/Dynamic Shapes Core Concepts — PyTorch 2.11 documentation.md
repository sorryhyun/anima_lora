# Dynamic Shapes Core Concepts[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#dynamic-shapes-core-concepts "Link to this heading")
...
## Symbolic integers[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#symbolic-integers "Link to this heading")
...
[The Zero-One Specialization Problem](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_zero_one_specialization.html#zero-one-specialization).

## Guards[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#guards "Link to this heading")
...
## Runtime Asserts[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#runtime-asserts "Link to this heading")
...
## “Hint” Value[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#hint-value "Link to this heading")
...
## Dynamic Behavior Overview[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#dynamic-behavior-overview "Link to this heading")
...
See [`torch.compiler.set_stance()`](https://docs.pytorch.org/docs/stable/generated/torch.compiler.set_stance.html#torch.compiler.set_stance "torch.compiler.set_stance") for more details.

## Overall Architecture[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#overall-architecture "Link to this heading")
...
## Internal API Class Hierarchy[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#internal-api-class-hierarchy "Link to this heading")

### Python Classes[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#python-classes "Link to this heading")
...
### C++ Equivalents[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#c-equivalents "Link to this heading")
...
## Value Ranges and Constraints[#](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_core_concepts.html#value-ranges-and-constraints "Link to this heading")
...
- [Dynamic Shapes](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/torch.compiler_dynamic_shapes.html#dynamic-shapes)
- [Troubleshooting Dynamic Shapes](https://docs.pytorch.org/docs/stable/user_guide/torch_compiler/compile/dynamic_shapes_troubleshooting.html#dynamic-shapes-troubleshooting)