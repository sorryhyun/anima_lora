...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert LoRA format between anima_lora and ComfyUI")
    parser.add_argument(
        "src_path",
        type=str,
    ...
    parser.add_argument("--reverse", action="store_true", help="reverse conversion direction (ComfyUI -> anima_lora)")
