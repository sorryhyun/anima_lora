...
火宮チナツ → in) at zero dependency cost.
    ...
    python -m scripts.distill_cjk.corpus.tag_glossary            # CPU, sources 1/2/4
...
from scripts.distill_cjk.corpus import build_pairs, kanji_allow  # noqa: E402
from scripts.distill_cjk.corpus.mt import (  # noqa: E402  (MT exemplars)
    TAG_FEWSHOT,
    TAG_FEWSHOT_KO,
    TAG_FEWSHOT_ZH,
)
...
def tag_counts(
    ...
    """
    from scripts.distill_cjk.corpus.build_pairs import load_captions  # noqa: PLC0415
...
def _mt_pass(tags: dict[str, dict], args: argparse.Namespace) -> None:
    ...
    """
    from scripts.distill_cjk.corpus.mt import (  # noqa: PLC0415
        TAG_BACKGROUND,
        TAG_BACKGROUND_KO,
        TAG_BACKGROUND_ZH,
        TAG_FEWSHOT,
    ...
    if args.lang == "ja" and not args.no_tag_pairs:
        from scripts.distill_cjk.corpus import tag_pairs  # noqa: PLC0415  (sibling — the shared source + guards)
