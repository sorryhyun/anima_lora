...
Usage (CPU)::
    ...
    python -m scripts.distill_cjk.corpus.build_pairs_sym --dry-run
    python -m scripts.distill_cjk.corpus.build_pairs_sym
...
REGISTER = "tags_sym"
DEFAULT_GLOSSARY = tag_glossary.ASSETS / "tag_glossary_sym.json"
