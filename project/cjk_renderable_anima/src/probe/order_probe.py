...
size, steps, cfg and seeds as the wake eval EN group.
    ...
    make daemon-run ARGS="--label order-probe --queue \\
        project/cjk_renderable_anima/src/probe/order_probe.py"
...
from common.models import decode_image, gen_args, load_vae  # noqa: E402
from common.paths import OUT  # noqa: E402
from common.prompts import TPL_EN  # noqa: E402
from common.readers import Readers, contact_sheet, load_bgr  # noqa: E402
from common.text import cer, norm  # noqa: E402
