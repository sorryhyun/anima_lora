...
kata) vs kanji/other (the two 53k family directions have cos 0.65).
    ...
    .venv/bin/python project/cjk_renderable_anima/probes/transplant_table.py
    # then per cond:
    make daemon-run ARGS="--stall-timeout 0 project/cjk_renderable_anima/probes/wake_probe.py \
