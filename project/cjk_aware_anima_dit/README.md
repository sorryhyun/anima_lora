...
not, where the headroom is), [`findings.md`](findings.md) is every settled
verdict with its evidence pointer. Read `findings.md` § Label basis before
...
- [`plan.md`](plan.md) — freeze note + pointer to the archived plans.
