...
tested at scale — [`plan.md`](plan.md) is the freeze note (what ran, what did
not, where the headroom is) plus **§ Still open**, the open items of the two
lines that reopened after the freeze and were archived 2026-09-12
(`plan_vl_respace.md`, `plan_render.md`); [`findings.md`](findings.md) is every
settled verdict with its evidence pointer. Read `findings.md` § Label basis before
comparing any two numbers in it: the sincos gate changed units twice.
...
- [`plan.md`](plan.md) — freeze note, § Still open, and the pointer to the
  archived plans.
- `ocr/`, `probes/`, `render/`, `assets/` — this line's code, still runnable. The hand
...
- Archived (gitignored, private mirror): the seven plan files →
