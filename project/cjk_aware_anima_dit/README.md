...
- [`findings.md`](findings.md) — **read first.** Every settled verdict in the
  ...
  line.
- [`cjk_renderable_anima/reports/`](../cjk_renderable_anima/reports/README.md) — moved with the wake line to `cjk_renderable_anima/` (2026-09-14; the frozen copy here is archived). Was the live plan (W2d encoder → W3 strings →
