...
(24 pairs, seeds 12/13/14) graded 2026-09-06: **C11 11 – 9 C10, tie 4 = flat inside the floor → blind half PASS** (spam half on one seed); `DROP_KINDS` flip owed (`findings.md` § O4b). **O5 parked** (user's call, same evening):
