...
> **Record (moved from `next.md`, 2026-09-26).** Every "next" in it ran or
> was dropped: § 0 superseded by `grid_box_2026_09_25.md`, § 0b / § 1–3
> never ran (and their argv is the pre-collapse surface), § 4–5 are
> `run0925_300f` and its follow-ups. Section numbers are kept — the reports
> cite them. The forward plan is `../proposal.md`.
