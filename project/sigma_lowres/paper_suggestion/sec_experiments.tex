...
publish as the verdict. The coherent drift no batch size removes is
bounded only by an $a + b/B$ fit across pool sizes, the designated
readout of a debiased verdict grid at the trainer's actual
