...
of $14$ interior bins, dense below $\sigma = 0.1$ and above $0.9$,
...
floor-mimicking signature \S\ref{sec:reduction} derives, directly
and at substantial magnitude at our
operating point: a first-order variance estimate predicts spurious
iso-direction
...
target-content
share \emph{in the angular estimand}. The flatness is not an
unexplained cancellation. The target-mediated gradient itself is real and
