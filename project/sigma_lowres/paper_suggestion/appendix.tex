...
$\Phi_{1120}$, $\mathrm{Resid}_{768}$) --- wherever the source edge is
...
the low-norm amplification behind the interior peak of the measured
curves.
...
--- the low-norm amplification above surfacing along
