...
actually follows). These are different estimands --- the aggregation
operator is part of the estimand --- and no coefficient fitted on
one is guaranteed to transfer to the other. At second order the two
...
automatic --- it would require an iid zero-mean disagreement model we
have not verified --- but where we have measured the batch object it
