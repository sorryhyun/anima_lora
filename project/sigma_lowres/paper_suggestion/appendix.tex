...
endpoint gap ($+0.042$) averages out in the aggregate ($+0.001$).
...
debiased $\rho$. Amplitude-matched legs leave a stub of a resultant
...
not found (Fig.~\ref{fig:ledgergeom}). The three arm means are values of one map on a
