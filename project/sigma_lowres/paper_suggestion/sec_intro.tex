...
downscaled step delivers the native gradient under an unchanged
objective. That is the route this paper takes. What a training step
...
(Table~\ref{tab:accounts}), and every experiment is a place they
disagree.
