...
as a drop-in substitute for the native one, with the model, the
...
both factors of $g = J^{\!\top}r$ and reduces, under mild,
realistic assumptions, to a route amplitude on a universal mismatch
curve \emph{plus} a $\sigma$-independent term set by the target
grid's token count. The two differ structurally before
