...
self-floors, a draw-count extrapolation, and a stated certification
resolution, the mildest route ($1024{\to}896$) is indistinguishable
from the re-encode control for $\sigma > 0.5$, while no noise level
