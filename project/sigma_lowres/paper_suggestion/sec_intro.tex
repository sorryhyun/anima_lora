...
atop a persistent floor, while no noise level rescues a $2\times$
downscale. No member of the spectral tolerance family reproduces that
map --- in particular, none locates the $1024{\to}768$ window, nor
the absence of any for $1024{\to}512$ --- and at the curve level its
one free parameter is inert. Head to head on the same curves it misses at
