...
retrain with non-deterministic kernels reads $0.264$ (run-to-run
chaos alone) --- and the yardstick
...
endpoint less than changing the training seed, and the $\sigma{>}0.5$ gate
...
tolerance reproduces the map, and a $2\times$-downscaled latent certifies at no noise
