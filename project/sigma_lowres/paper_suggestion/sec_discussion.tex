...
holds at the certification resolution of \S\ref{sec:instrument}, on
the \emph{per-example} object --- the map needs no table:
...
zero, and formal certification at the strict $0.02$ margin is achieved
at $\sigma = 0.688$.
