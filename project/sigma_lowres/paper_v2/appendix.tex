...
+ \|R_e^{\perp}\|^2\Big),
\end{equation*}
whose first three terms, divided by $2G^2$, are the data share $S_e$,
the graph share $\Phi_e$, and the projected interaction $I_e$ of the
four-term expansion, Eq.~\ref{eq:fourterm}. The remainder
$R'_e$ has an exact expansion: the
...
than an assumption. The second says the first-order part of the remainder
