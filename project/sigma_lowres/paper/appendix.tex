...
\begin{equation}
\delta g \;=\; \bar g_e - \bar g_{\mathrm{src}}
\;=\;
...
- \mathbb{E}_\epsilon\!\big[\tilde J_{\mathrm{src}}^{\!\top}
\tilde r_{\mathrm{src}}\big]}_{R_e}.
...
literal. Across grids, $J_{\mathrm{src}}$ and $J_e$ act on different
...
Write $g = \bar g_{\mathrm{src}}$, $G = \|g\|$, $\hat g = g/G$, and
decompose
...
the bin-mean $G(\sigma)$ are run-level instruments with no per-image
...
$f_{\mathrm{cut}} = \tfrac{1}{2}\,e/e_{\mathrm{src}}$ on the $N{=}40$
