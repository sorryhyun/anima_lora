...
| [E25b](experiments/e25b/) | explicit resolution conditioning (adaln micro-conditioning arm) | **STAGE 1 IMPROVES 2026-08-12; STAGE 2 FROZEN 2026-08-12** | 25b-1 **IMPROVES** (median r_h 0.572 ≤ 0.9, median Δρ +0.005; 5/5 bins readable both stores, all gates pass; shallow-σ concentrated, graph leg h(C) shrinks at every bin); Stage 2 ship read **registered frozen** — E16.1 full-scale grid, 5 arms (adds sigma768 rescue pair) + determinism control, 25b-2 ship gates (in-batch yardstick both corpora + wall ≤ +1 % of combo) + 25b-3 paired rescue read, ≈ 5–6 GPU-h; **blocked on Stage 2.0** (inference-side res-cond wiring — keep-live loader currently drops the projection) |
