...
| [E24](experiments/e24/) | cancellation-axis geometry: is the cancelled direction one global mode? | **PLANNED 2026-08-08** | CPU-only cross-condition read of the three surviving arm_sums stores — axis cosines across σ/route/store + residual knob decomposition (angle vs amplitude); E23a/b names reserved by E22's gated lever sketch |
