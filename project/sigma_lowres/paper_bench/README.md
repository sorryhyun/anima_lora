...
| [E25b](experiments/e25b/) | explicit resolution conditioning (adaln micro-conditioning arm) | **STAGE 1 IMPROVES 2026-08-12; STAGE 2 FROZEN 2026-08-12** | 25b-1 **IMPROVES** (median r_h 0.572 ≤ 0.9, median Δρ +0.005; 5/5 bins readable both stores, all gates pass; shallow-σ concentrated, graph leg h(C) shrinks at every bin); Stage 2 read **registered frozen** (amended 2026-08-12) — E16.1 full-scale grid, 5 arms (adds sigma768 rescue pair) + determinism control; 25b-2 quality gate = in-batch yardstick both corpora (throughput measured, not gated; ΔW-toward-native = registered secondary, not the bar; **pass ⇒ paper-method update, no product ship**) + 25b-3 paired rescue read, ≈ 5–6 GPU-h; Stage 2.0 wiring **landed** (`_attach_res_cond`) + **grid launched 2026-08-12** (31 jobs, `e25b_stage2_jobs.json`) |
