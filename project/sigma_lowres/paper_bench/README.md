...
| [E22](experiments/e22/) | per-image g-ledger: does the cancellation hold per sample? | DONE 2026-08-08 · **22.4 PLANNED** | **INSTRUMENT-LIMITED** (3–5/16 gated vs ≥ 8 floor at D = 24); descriptively HOLDS-shaped (all 48 ρ_i negative, median −0.815) but no per-sample lever licensed; 22.4 = pre-registered D = 96 single-σ (0.7) rerun |
...
| [E25](experiments/e25/) | σ-local angle lever (population-level exploitation) | **SKETCH 2026-08-08 — not pre-registered** | the E24-STRUCTURED-named follow-up: E25a σ-binned residual projection guard / E25b explicit resolution conditioning of adaln; freeze blocked on E25.0 (residual-direction reliability + frame-relative stationarity, CPU) and an explicit E20.4-adjacency justification; per-sample variants stay E23a-gated |
