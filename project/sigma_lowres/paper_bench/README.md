...
| [E26](experiments/e26/) | cross-adapter cancellation geometry (the preserved E7 pair) | **E26.0 SMOKE PRE-REG 2026-08-09** | go/no-go at σ = 0.7/768 on `e7_flat` + `e7_dirty` (e193-matched protocol, ~0.57 GPU-h each); full grid gated on the smoke + its own freeze amendment; sets the breadth of the paper_v2 geometry scope sentence |
