...
| **Depends on** | [E16](../e16/) (the propagator identity + regime probe + twin checkpoints), [E4](../e4/)'s [`claim_accumulated_bias.md`](../e4/claim_accumulated_bias.md) (the three surviving worries, mapped 1:1 onto 18.0/18.1/18.2), [E9](../e9/) (paired in-window difference structure), [E11](../e11/) (probe harness + probe set), [E15](../../../record/e15/) (per-sample second moment — see Groundings for why it does *not* pre-empt 18.0), [E7](../e7/) (cross-checkpoint map replication — prior for 18.2), `methods.md` `--deterministic` (no chaos floor in 18.2) |
