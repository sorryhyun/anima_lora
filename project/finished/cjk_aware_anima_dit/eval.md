...
Regenerate with `python project/finished/cjk_aware_anima_dit/ocr/eval_table.py --write`
...
| `vl16_lr1e-4` | **157** / 617 (25.4 %) | 110 | 1704 / 2558 (66.6 %) | 2210 / 2559 (86.4 %) | 0 / 192 | 66.2 % | arm B — LoRA, tower frozen |
| `vl16_tower_lr1e-5` | **375** / 617 (60.8 %) | 312 | 2127 / 2558 (83.2 %) | 2260 / 2559 (88.3 %) | 1 / 192 | 86.2 % | **arm B′** — LoRA + tower unfrozen; the published reader |
| `vl16_tower_col100` | **377** / 617 (61.1 %) | 323 | 2171 / 2558 (84.9 %) | 2249 / 2559 (87.9 %) | 0 / 192 | 85.6 % | B′ + 1.6 % colorized append |
| `vl16_tower_col1500sw` | **341** / 617 (55.3 %) | 281 | 2188 / 2558 (85.5 %) | 2264 / 2559 (88.5 %) | 1 / 192 | 86.1 % | B′ + 22.3 % colorized swap |
| `vl16_pl_20k` | **402** / 617 (65.2 %) | 334 | 2189 / 2558 (85.6 %) | 2260 / 2559 (88.3 %) | 0 / 192 | 86.1 % | B′ + 20.6 % pseudo-label append (P1, cross-reader agreement) |
| `vl16_pl_kozh` | **391** / 617 (63.4 %) | 331 | 2167 / 2558 (84.7 %) | 2272 / 2559 (88.8 %) | 14 / 192 | 86.9 % | B′ + 27.5 % pseudo append (P1 JA 20k + K2 KO 5 930 / ZH 3 300) |
| `vl16_b2_norm2` | **350** / 617 (56.7 %) | 297 | 2138 / 2558 (83.6 %) | 2255 / 2559 (88.1 %) | 19 / 192 | 87.0 % | B′ recipe verbatim under TARGET_NORM 2 (plan_vl_respace R2) |
| `vl16_b2_norm3` | **319** / 617 (51.7 %) | 274 | 2157 / 2558 (84.3 %) | 2255 / 2559 (88.1 %) | 17 / 192 | 87.3 % | norm2 + glyph fold, heart → `♡` (TARGET_NORM 3, R5) — lost every raw `♥` |
| `vl16_b2_norm4` | **354** / 617 (57.4 %) | 305 | 2147 / 2558 (83.9 %) | 2254 / 2559 (88.1 %) | 16 / 192 | 86.8 % | norm2 + glyph fold, heart → `♥` (TARGET_NORM 4, R5b) — **Hub v3**; sincos on the 2026-09-12 corrected labels (rows above: pre-fix) |
| `vl16_tower_ep3` | **360** / 617 (58.3 %) | 306 | 2234 / 2558 (87.3 %) | 2287 / 2559 (89.4 %) | 1 / 192 | 88.3 % | B′ × 3 epochs |
| `vl16_lpft` | **345** / 617 (55.9 %) | 264 | 2157 / 2558 (84.3 %) | 2244 / 2559 (87.7 %) | 0 / 192 | 86.8 % | LP-FT — arm B then B′ |
| `vl16_tower_ssl` | **380** / 617 (61.6 %) | 307 | 2165 / 2558 (84.6 %) | 2259 / 2559 (88.3 %) | 0 / 192 | 87.2 % | B′ from an SSL tower (draw20k, 4.4k steps) |
| `vl16_tower_ssl_all` | **378** / 617 (61.3 %) | 301 | 2194 / 2558 (85.8 %) | 2260 / 2559 (88.3 %) | 0 / 192 | 87.8 % | B′ from an SSL tower (manifest_all, 12k steps) |
| `vl16_tower_ssl_all_lr5e5` | **378** / 617 (61.3 %) | 288 | 2188 / 2558 (85.5 %) | 2266 / 2559 (88.6 %) | 1 / 192 | 87.8 % | same tower, LoRA lr 5e-5 |
