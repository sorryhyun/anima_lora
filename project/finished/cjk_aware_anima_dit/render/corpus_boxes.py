...
Stages, each idempotent and resumable per page::
    ...
    make daemon-run ARGS="--stall-timeout 0 project/finished/cjk_aware_anima_dit/render/corpus_boxes.py det --corpus <root> --editions en ja --per_work 4"
    make daemon-run ARGS="--stall-timeout 0 project/finished/cjk_aware_anima_dit/render/corpus_boxes.py read --corpus <root> --editions en ja"
    # CPU: bubbles (box clusters + script guard), panels (XY-cut + bubble assignment), the hand-check sheet
    python project/finished/cjk_aware_anima_dit/render/corpus_boxes.py bubbles --corpus <root> --editions en ja
    python project/finished/cjk_aware_anima_dit/render/corpus_boxes.py panels --editions en ja
    python project/finished/cjk_aware_anima_dit/render/corpus_boxes.py sheet --corpus <root> --editions ja --n 40
