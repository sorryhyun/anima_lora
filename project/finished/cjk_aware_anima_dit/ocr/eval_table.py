#!/usr/bin/env python3
"""Regenerate ``project/finished/cjk_aware_anima_dit/eval.md`` — every reader on one basis.

    python project/finished/cjk_aware_anima_dit/ocr/eval_table.py           # print
    python project/finished/cjk_aware_anima_dit/ocr/eval_table.py --write   # write eval.md
