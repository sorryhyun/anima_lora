...
"""Re-score every reader row of the sincos gate on the current labels (one daemon job).
    ...
    make daemon-run ARGS="--stall-timeout 0 project/finished/cjk_aware_anima_dit/ocr/reeval_sfx_all.py"
...
EVAL = REPO / "project/finished/cjk_aware_anima_dit/ocr/eval_sfx.py"
ROWS = [
