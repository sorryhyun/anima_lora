...
"""O1 crop builder (``plan_ocr.md``): Manga109-s COO + speech crops by the official split.
    ...
    python project/finished/cjk_aware_anima_dit/ocr/build_manga109_crops.py --write_split
    python project/finished/cjk_aware_anima_dit/ocr/build_manga109_crops.py --split test   # O0's cut
    python project/finished/cjk_aware_anima_dit/ocr/build_manga109_crops.py --workers 8   # all splits
    python project/finished/cjk_aware_anima_dit/ocr/build_manga109_crops.py --stats_only  # findings block
