...
Spotting → MIT mask components) — in front of the SFX reader?
    ...
    make daemon-run ARGS="--stall-timeout 0 project/finished/cjk_aware_anima_dit/ocr/animetext_det_probe.py --stage det read"
    # CPU: coverage vs the current stack + hand labels, floor, manga-ocr best-match, sheets
    python project/finished/cjk_aware_anima_dit/ocr/animetext_det_probe.py --stage eval
