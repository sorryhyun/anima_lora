...
jobs)::
    ...
    make daemon-run ARGS="--label sentprobe --stall-timeout 0 --queue \
        project/finished/cjk_aware_anima_dit/probes/sentence_spam_probe.py --stage all"
"""
...
def main() -> None:
    ...
    ap.add_argument(
        "--out", default="project/finished/cjk_aware_anima_dit/reports/sentence_spam_probe.json"
    )
