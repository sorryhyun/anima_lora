...
that can be re-run on a new arm.
    ...
    .venv/bin/python project/finished/cjk_aware_anima/probes/unmask_grid_ocr.py \
        --arms C2 C5 C3 C4 C9 P --out project/finished/cjk_aware_anima/reports/unmask_grid_ocr.json
"""
