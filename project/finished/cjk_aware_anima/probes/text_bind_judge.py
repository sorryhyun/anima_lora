...
(rows = condition, cols = source | seed x render-arm).
    ...
    .venv/bin/python project/finished/cjk_aware_anima/probes/text_bind_judge.py \
        --prompts project/finished/cjk_aware_anima/assets/text_bind_prompts_9095721.json \
        --glob 'bench/cjk_adapter/results/*textbind-*-9095721-s*' \
        --out project/finished/cjk_aware_anima/reports/textbind_9095721.json
"""
