...
CPU-safe (`--device cpu`) so it can run beside a live GPU job.
    ...
    .venv/bin/python project/finished/cjk_aware_anima/probes/unmask_grid_judge.py \
        --arms A C2 C9 P R --out project/finished/cjk_aware_anima/reports/unmask_grid_judge.json
"""
