...
project/finished/cjk_aware_anima/findings.md (§6).
...
Usage (CPU)::
    ...
    python project/finished/cjk_aware_anima/gates/separability.py \
        --pack output/ckpt/cjk_vocab/cjk_vocab_pack_item2.safetensors \
        --out project/finished/cjk_aware_anima/assets/separability_phase02.json
"""
