...
GPU work goes through the daemon:
    ...
    make daemon-run ARGS="project/finished/cjk_aware_anima/datasets/manga_text.py --sample 1000"

CPU smoke (crops only, no model):

    uv run python project/finished/cjk_aware_anima/datasets/manga_text.py --sample 24 --no-ocr
"""
