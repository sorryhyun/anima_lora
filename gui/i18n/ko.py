...
STRINGS: dict[str, str] = {
    ...
    "models_btn": "모델",
    "models_btn_tooltip": "모델 체크포인트 다운로드 / 재다운로드 — Anima 가중치와 anime_tools 큐레이션 가중치를 한곳에서",
    "update_btn": "업데이트",
    ...
    "models_intro": "학습 / 추론 실행에 필요한 가중치입니다. '첫 실행 세트 다운로드'는 Anima 가중치 3종, PE, 태거 체크포인트, 태그 DB를 받습니다. SAM3와 OCR 스택 등은 '큐레이션' 탭에 있습니다. 파일은 models/ 아래에 저장됩니다.",
