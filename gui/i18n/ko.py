...
STRINGS: dict[str, str] = {
    ...
    "models_btn": "모델",
    "models_btn_tooltip": "Anima 가중치 다운로드 / 재다운로드 (베이스 DiT, 텍스트 인코더, VAE, PE-Core, CJK 어휘 팩)",
    "update_btn": "업데이트",
    ...
    "models_intro": "학습 / 추론 실행에 필요한 가중치입니다. '첫 실행 세트 다운로드'는 Anima 가중치 3종, PE, 태거 체크포인트, 태그 DB를 받습니다. SAM3와 OCR 스택 등은 '큐레이션 모델'에 있습니다. 파일은 models/ 아래에 저장됩니다.",
    ...
    "model_vocab_pack": "CJK 어휘 팩 — 일본어 / 한국어 / 중국어 캡션 행 (선택)",
    "model_pe_spatial": "PE-Spatial-B16-512 — REPA + 유사 이미지 그룹화",
    "models_used_by": "사용처: {what}",
    "curation_models_btn": "큐레이션 모델",
    "curation_models_btn_tooltip": "anime_tools 큐레이션 가중치 다운로드 (Anima 태거, SAM3, PE-Spatial, 태그 DB, OCR)",
    "curation_models_title": "큐레이션 모델 (anime_tools)",
    "curation_models_intro": "큐레이션 단계용 가중치 — 태깅, 마스킹, 그룹화, 캡션 교정, OCR. anime_tools 카탈로그를 그대로 읽습니다. 각 단계는 첫 실행 시 직접 받기도 하므로, 여기서는 대기 시간을 옮길 뿐입니다.",
