...
STRINGS: dict[str, str] = {
    ...
    "models_btn": "Models",
    "models_btn_tooltip": "Download or re-download model checkpoints — the Anima weights and the anime_tools curation weights, in one place",
    "update_btn": "Update",
    ...
    "models_intro": "The weights a training or inference run needs. 'Download the first-run set' fetches the three Anima weights, PE, the tagger checkpoint and the tag DB. SAM3, the OCR stack and the rest are on the Curation tab. Files are saved under models/.",
