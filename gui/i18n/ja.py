...
STRINGS: dict[str, str] = {
    ...
    "models_btn": "モデル",
    "models_btn_tooltip": "モデルチェックポイントをダウンロード / 再ダウンロード — Anima の重みと anime_tools のキュレーション用重みをまとめて",
    "update_btn": "更新",
    ...
    "models_intro": "学習 / 推論の実行に必要な重みです。「初回セットをダウンロード」で Anima の重み 3 点、PE、タガーのチェックポイント、タグ DB を取得します。SAM3 や OCR スタックなどは「キュレーション」タブにあります。ファイルは models/ に保存されます。",
