...
STRINGS: dict[str, str] = {
    ...
    "models_btn": "模型",
    "models_btn_tooltip": "下载或重新下载模型检查点 — Anima 权重与 anime_tools 策展权重, 集中于一处",
    "update_btn": "更新",
    ...
    # Models dialog
    "models_title": "下载模型",
    "models_intro": "训练 / 推理运行所需的权重。「下载首次运行套件」会获取 3 个 Anima 权重、PE、标注器检查点与标签 DB。SAM3、OCR 组件等位于「策展」标签页。文件保存于 models/ 下。",
